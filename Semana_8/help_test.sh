...
echo -e "\e[1mTEST COMMAND HELP\e[m
        > Nos exemplos serão usadas chaves duplas na construção dos testes.
...
outros caracteres também acabam precisando serem escapados para que o comando funcione corretamente.
        ...
        > Chaves duplas também dão acesso aos wildcards *, ?, aos grupos de caracteres usando [].
"
